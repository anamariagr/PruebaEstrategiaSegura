(function () {
    ...
    var AVATAR_COLORS = ['#1e293b', '#0f766e', '#1d4ed8', '#7c3aed', '#b45309', '#0284c7'];
    var colorIndex = 0;
    ...
    // ── Colapsar / expandir (delegar en la lista) ─────────────────
    if (commentsList) {
        ...
        saveBtn.addEventListener('click', function () {
            ...
            if (!text) {
                if (textarea) {
                    ...
                    textarea.focus();
                    setTimeout(function () { textarea.classList.remove('textarea-invalid'); }, 1500);
                }
                return;
            }
    ...
    function buildCommentCard(text, type, dateStr) {
        ...
        div.innerHTML =
            '<div class="comment-avatar" style="background:' + color + '">U</div>' +
            '<div class="comment-content">' +
            '<div class="comment-top">' +
            '<div class="comment-info">' +
            '<span class="comment-author">Usuario actual</span>' +
            '<span class="comment-badge ' + badgeClass + '">' + badgeSvg + badgeLabel + '</span>' +
            '</div>' +
